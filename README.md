...
<script>
    ...
    const SKINS = [
        ...
        { id: 1, name: "LED CHROMA", color: "chroma", price: 150 }, // Mais cara por ser especial
        { id: 2, name: "Galaxy X", color: "#cc00ff", price: 80 },   
        { id: 3, name: "Ouro Puro", color: "#ffd700", price: 120 }
    ];

    // Gerador de skins com preços variados (14, 20, 30, 50)
    ...
    function update() {
        ...
        if (Date.now() - lastSpawn > 1600) {
            ...
            gameCoins.push({ x: canvas.width + 150, y: 250, collected: false });
            lastSpawn = Date.now();
        }
